...
class `Screen Locking Patterns` {
    ...
    val DIRECTIONS:Array<Pair<Int,Int>> = arrayOf((0 to 1),(0 to -1),(1 to 0),(-1 to 0),
        ...
        (1 to 2),(2 to 1),(1 to -2),(-2 to 1),(-2 to -1),(2 to -1),(-1 to 2)
    )
    ...
    fun validateStep(direction:Pair<Int,Int>, map:Array<Array<Char>>, currentX:Int, currentY:Int) = makeStep(map, direction,currentX,currentY,true)
    fun makeStep( map:Array<Array<Char>>, direction:Pair<Int,Int>, currentX:Int, currentY:Int, onlyValidate: Boolean = false):Triple<Char,Int,Int>?{
    ...
    fun findPaths(map: Array<Array<Char>>, direction: Pair<Int,Int>, currentX: Int, currentY: Int, path: MutableList<Char>, length:Int ){
